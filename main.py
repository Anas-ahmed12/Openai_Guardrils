...
input_guardrails_agent = Agent(
    ...
    instructions="Check it if the user's question is related to Python programming, if it is, return True, if its not return False",
    model=model,
...
@cl.on_chat_start
async def on_chat_chat():
    await cl.Message(content="Hello, I am a Python expert agent. How can I help you with Python programming?").send()
...
async def on_message(message: cl.Message):
    try:
        ...
        await cl.Message(content="I'm sorry, I can't help with that. Please ask a Python related question.").send()
